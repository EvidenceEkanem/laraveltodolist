            ...
            <div class="box">
                ...
                <div class="field has-addons">
                    <div class="control is-expanded">
                        <input class="input" type="text" placeholder="New task" v-model="task.name">
                    </div>
                    <div class="control">
                ...
                <div class="card" v-for="task in list">
                    ...
                    <div class="card-content">
                        <div class="content">
                            ...
                            <input class="input" v-if="task === editingTask" v-autofocus @keyup.enter="endEditing(task)" @blur="endEditing(task)" type="text" placeholder="New task" v-model="task.name">
                        </div>
                    </div>
